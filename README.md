...
[![tests](https://img.shields.io/badge/tests-870%20passing-30d158?style=flat-square)](VERIFICATION.md#the-test-suites)
...
| 🧪 | **The numbers regenerate themselves.** 870 tests, 174 seeded faults, and a check that fails CI if any document disagrees with the suites. | `node scripts/counts.mjs --check` |
...
**870 tests**: 598 frontend · 161 server · 111 contract (91 unit, 15 fuzz, 5 invariant).
