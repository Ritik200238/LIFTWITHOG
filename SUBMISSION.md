...
- **Reproducible deployment:** [DEPLOYMENTS.md](DEPLOYMENTS.md) — source verified on the explorer; `node scripts/verify-deployment.mjs 16661` rebuilds it and checks mainnet byte for byte, from a fresh clone
...
```
870 tests    598 frontend · 161 server · 111 contract
