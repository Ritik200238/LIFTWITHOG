...
```bash
npm --prefix frontend test     # 598 tests — app logic, nutrition, coach memory, sync, offline
...
870 in total. `node scripts/counts.mjs` prints these by running the suites, and
