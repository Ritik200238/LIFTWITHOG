...
export async function api(path, opts) {
  ...
  // The body rides along on the error. A 409 from /api/data carries the state
  // that beat this write, and without it the client can only give up — which
  // is how a losing write used to become lost training.
