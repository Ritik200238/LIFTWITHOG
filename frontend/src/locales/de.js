...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LIFTWITHOG locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst LIFTWITHOG trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install LIFTWITHOG as a full-screen app.': 'um LIFTWITHOG als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if LIFTWITHOG is closed.': 'Pausen-Timer-Alarm, auch wenn LIFTWITHOG geschlossen ist.',
  ...
  'A small file a friend imports into their own LIFTWITHOG — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes LIFTWITHOG importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'this isn’t an LIFTWITHOG plan file': 'das ist keine LIFTWITHOG-Plandatei',
  'Shared routine': 'Geteilte Routine',
  'Unknown exercise': 'Unbekannte Übung',
  'Weekly Training Plan': 'Wochen-Trainingsplan',
  'Made with LIFTWITHOG': 'Erstellt mit LIFTWITHOG',
  ...
  'Reload LIFTWITHOG': 'LIFTWITHOG neu laden',
