...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OG_FITNESS locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst OG_FITNESS trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install OG_FITNESS as a full-screen app.': 'um OG_FITNESS als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if OG_FITNESS is closed.': 'Pausen-Timer-Alarm, auch wenn OG_FITNESS geschlossen ist.',
  ...
  'A small file a friend imports into their own OG_FITNESS — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes OG_FITNESS importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'this isn’t an OG_FITNESS plan file': 'das ist keine OG_FITNESS-Plandatei',
  'Shared routine': 'Geteilte Routine',
  'Unknown exercise': 'Unbekannte Übung',
  'Weekly Training Plan': 'Wochen-Trainingsplan',
  'Made with OG_FITNESS': 'Erstellt mit OG_FITNESS',
  ...
  'Reload OG_FITNESS': 'OG_FITNESS neu laden',
