...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LIFTWITHOG locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar LIFTWITHOG localmente en este dispositivo.',
  ...
  'to install LIFTWITHOG as a full-screen app.': 'para instalar LIFTWITHOG como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if LIFTWITHOG is closed.': 'Avisos del temporizador de descanso, incluso con LIFTWITHOG cerrado.',
  ...
  'A small file a friend imports into their own LIFTWITHOG — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio LIFTWITHOG: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload LIFTWITHOG': 'Recargar LIFTWITHOG',
