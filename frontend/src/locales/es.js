...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OG_FITNESS locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar OG_FITNESS localmente en este dispositivo.',
  ...
  'to install OG_FITNESS as a full-screen app.': 'para instalar OG_FITNESS como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if OG_FITNESS is closed.': 'Avisos del temporizador de descanso, incluso con OG_FITNESS cerrado.',
  ...
  'A small file a friend imports into their own OG_FITNESS — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio OG_FITNESS: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload OG_FITNESS': 'Recargar OG_FITNESS',
