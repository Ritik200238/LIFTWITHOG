...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OG_FITNESS locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर OG_FITNESS लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install OG_FITNESS as a full-screen app.': 'से OG_FITNESS को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if OG_FITNESS is closed.': 'आराम टाइमर अलर्ट, OG_FITNESS बंद होने पर भी।',
  ...
  'A small file a friend imports into their own OG_FITNESS — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने OG_FITNESS में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'this isn’t an OG_FITNESS plan file': 'यह OG_FITNESS प्लान फ़ाइल नहीं है',
  'Shared routine': 'साझा किया गया रूटीन',
  'Unknown exercise': 'अज्ञात व्यायाम',
  'Weekly Training Plan': 'साप्ताहिक ट्रेनिंग प्लान',
  'Made with OG_FITNESS': 'OG_FITNESS से बनाया गया',
  ...
  'Reload OG_FITNESS': 'OG_FITNESS फिर से लोड करें',
