...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OG_FITNESS locally on this device.": 'Этот браузер не поддерживает ключи доступа — но OG_FITNESS можно использовать локально на этом устройстве.',
  ...
  'to install OG_FITNESS as a full-screen app.': 'чтобы установить OG_FITNESS как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if OG_FITNESS is closed.': 'Оповещения таймера отдыха, даже если OG_FITNESS закрыт.',
  ...
  'A small file a friend imports into their own OG_FITNESS — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой OG_FITNESS — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload OG_FITNESS': 'Перезагрузить OG_FITNESS',
