...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LIFTWITHOG locally on this device.": 'Этот браузер не поддерживает ключи доступа — но LIFTWITHOG можно использовать локально на этом устройстве.',
  ...
  'to install LIFTWITHOG as a full-screen app.': 'чтобы установить LIFTWITHOG как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if LIFTWITHOG is closed.': 'Оповещения таймера отдыха, даже если LIFTWITHOG закрыт.',
  ...
  'A small file a friend imports into their own LIFTWITHOG — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой LIFTWITHOG — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload LIFTWITHOG': 'Перезагрузить LIFTWITHOG',
