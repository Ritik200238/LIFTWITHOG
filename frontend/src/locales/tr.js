...
export default {
  ...
  "This browser doesn't support passkeys — you can still use LIFTWITHOG locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de LIFTWITHOG’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install LIFTWITHOG as a full-screen app.': 'ile LIFTWITHOG’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if LIFTWITHOG is closed.': 'LIFTWITHOG kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own LIFTWITHOG — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi LIFTWITHOG\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
