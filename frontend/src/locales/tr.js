...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OG_FITNESS locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de OG_FITNESS’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install OG_FITNESS as a full-screen app.': 'ile OG_FITNESS’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'free & open source': 'ücretsiz ve açık kaynak',
  'Notifications': 'Bildirimler',
  'Not supported in this browser.': 'Bu tarayıcıda desteklenmiyor.',
  'Push notifications': 'Anlık bildirimler',
  'Rest-timer alerts, even if OG_FITNESS is closed.': 'OG_FITNESS kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own OG_FITNESS — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi OG_FITNESS\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
