...
export default {
  ...
  "This browser doesn't support passkeys — you can still use OG_FITNESS locally on this device.": '此浏览器不支持通行密钥——你仍可在本设备上本地使用 OG_FITNESS。',
  ...
  'to install OG_FITNESS as a full-screen app.': '即可将 OG_FITNESS 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if OG_FITNESS is closed.': '休息计时提醒，即使 OG_FITNESS 已关闭。',
  ...
  'A small file a friend imports into their own OG_FITNESS — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 OG_FITNESS——只有训练日，不包含你的训练记录或体重。',
