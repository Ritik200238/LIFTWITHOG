...
export default function Library() {
  ...
  return <>
    {/*
      * A way back, because this stopped being a tab.
      *
      * It was reached from the tab bar, so it never needed one. Moving it under
      * Plan left the only route in with no route out — you arrive here and the
      * only escape is a different tab, which loses where you were.
      */}
    <div className="hdr">
    ...
    <div className="list">
      ...
      {f.slice(0, shown).map(e => {
        ...
        return <button type="button" key={e.id} className="item" onClick={() => exerciseDetailSheet(e)}>
          <Thumb ex={e} />
